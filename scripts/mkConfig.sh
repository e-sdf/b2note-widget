...
JS_WIDGET_SERVER_URL=`[ -z "$JS_WIDGET_SERVER_URL" ] && echo "http://localhost:3061/widget" || echo "$JS_WIDGET_SERVER_URL"` 
...
echo -n "window.b2note = { widgetServerUrl: '"$JS_WIDGET_SERVER_URL"', apiServerUrl: '"$JS_API_SERVER_URL"', apiPath: '"$JS_API_PATH"', solrUrl: '"$JS_SOLR_URL"', customOntologies: "$JS_CUSTOM_ONTOLOGIES" };" > $C
